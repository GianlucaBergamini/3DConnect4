...
async function main() {
    ...
    function drawScene() {
        ...
        function sendUniformsToGPUAndDraw(viewMatrix, worldMatrix, perspectiveMatrix, vertexArray, specularPower, specularColor, mesh, text1) {
            ...
            gl.uniformMatrix4fv(positionMatrixHandle, gl.FALSE, utils.transposeMatrix(baseWorldMatrix));
        ...
        for (let i = 0; i < COINS; i++) {
            ...
            gl.uniformMatrix4fv(matrixLocation, gl.FALSE, utils.transposeMatrix(projectionMatrix));
            gl.uniformMatrix4fv(positionMatrixHandle, gl.FALSE, utils.transposeMatrix(coinWorldMatrix[i]));
