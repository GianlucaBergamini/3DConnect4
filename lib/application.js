...
async function main() {
    ...
    var innerCone = 60.0;
    var outerCone = 120.0;
    var spot1Pos = [-10.0, 1.0, 0.0];
    var spot1Dir = [10.0, -1.0, 0.0];
    var spot1Color = [1.0, 1.0, 1.0];
    var spot2Pos = [5.0, 1.0, 0.0]
    var spot2Dir = [-5.0, -1.0, 0.0];
    var spot2Color = [1.0, 1.0, 1.0];
    var spotLightTarget = 1.0;
    var spotLightDecay = 5.0;
