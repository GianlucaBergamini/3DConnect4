...
async function main() {
    ...
    const dirLightDirectionHandle = gl.getUniformLocation(program, 'dirLightDirection');
    const dirLightColorHandle = gl.getUniformLocation(program, 'dirLightColor');
    ...
    const spot1PositionHandle = gl.getUniformLocation(program, 'spotLight1Pos');
    const spot1DirectionHandle = gl.getUniformLocation(program, 'spotLight1Dir');
    const spot1LightColorHandle = gl.getUniformLocation(program, 'spotLight1Color');
    const spot2PositionHandle = gl.getUniformLocation(program, 'spotLight2Pos');
    const spot2DirectionHandle = gl.getUniformLocation(program, 'spotLight2Dir');
    const spot2LightColorHandle = gl.getUniformLocation(program, 'spotLight2Color');
    const spotTargetHandle = gl.getUniformLocation(program, 'spotLightTarget');
    const spotDecayHandle = gl.getUniformLocation(program, 'spotLightDecay');
    ...
    const innerConeHandle = gl.getUniformLocation(program, 'innerCone');
    const outerConeHandle = gl.getUniformLocation(program, 'outerCone');
    ...
    const directionalLight = [Math.cos(dirLightAlpha) * Math.cos(dirLightBeta),
