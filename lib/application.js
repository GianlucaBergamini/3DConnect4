...
const dirLight1Alpha = -utils.degToRad(0);
const dirLight1Beta = -utils.degToRad(0);
const directionalLight1Color = [1.0, 1.0, 1.0];
const dirLight2Alpha = -utils.degToRad(-120);
const dirLight2Beta = -utils.degToRad(0);
const directionalLight2Color = [1.0, 1.0, 1.0];
...
async function main() {
    ...
    const directionalLight1 = [Math.cos(dirLight1Alpha) * Math.cos(dirLight1Beta),
        Math.sin(dirLight1Alpha),
        Math.cos(dirLight1Alpha) * Math.sin(dirLight1Beta)
    ];

    const directionalLight2 = [Math.cos(dirLight2Alpha) * Math.cos(dirLight2Beta),
        Math.sin(dirLight2Alpha),
        Math.cos(dirLight2Alpha) * Math.sin(dirLight2Beta)
    ];
    ...
    function drawScene() {
        ...
        gl.uniform3fv(dirLight1ColorHandle, directionalLight1Color)
        ...
        gl.uniform3fv(dirLight2ColorHandle, directionalLight2Color)
