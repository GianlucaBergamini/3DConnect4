...
let dirLight1Alpha = -utils.degToRad(0);
let dirLight1Beta = -utils.degToRad(0);
let directionalLight1Color = [1.0, 1.0, 1.0];
let dirLight2Alpha = -utils.degToRad(-120);
let dirLight2Beta = -utils.degToRad(0);
let directionalLight2Color = [1.0, 1.0, 1.0];
