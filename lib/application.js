...
async function main() {
    ...
    function drawScene() {
        ...
        for (let i=0; i<COINS; i++) {
            if (i !== currentCoin || moveAnimationOn === false)
            ...
            else coinWorldMatrix[i] = utils.MakeWorld(movePosition[0] * pinOffset,coinPosition[i][1] * coinHeight, movePosition[1] * pinOffset, 0.0, 0.0, 0.0, coinS);
        }
