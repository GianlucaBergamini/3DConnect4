...
async function loadBase() {
	var baseStr = await utils.get_objstr("assets/objs/base.obj");
	var baseModel = new OBJ.Mesh(baseStr);
	var baseVertices = baseModel.vertices; //Array of vertices
	var baseNormals = baseModel.normals; //Array of normals
	var baseIndices = baseModel.indices; //Array of indices
	var baseTexCoords = baseModel.textures; //Array of uv coordinates
}

async function loadCoin() {
	var coinStr = await utils.get_objstr("assets/objs/coin.obj");
	var coinModel = new OBJ.Mesh(coinStr);
	var coinVertices = coinModel.vertices; //Array of vertices
	var coinNormals = coinModel.normals; //Array of normals
	var coinIndices = coinModel.indices; //Array of indices
	var coinTexCoords = coinModel.textures; //Array of uv coordinates
}
